...
static inline csr2word_t litecsr_adjust_csr2(csr2word_t x) {
    return csr_swap_words(x);
}                                                                                        // 64-bit values are inverted
static inline csr1word_t litecsr_adjust_csr1(csr1word_t x) {
    return x;
}
